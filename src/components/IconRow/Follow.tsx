...
export const Follow = () => (
  <div class={styles.IconRow}>
    <a href="https://connect.thrivent.com/sameer-bham">
      <img prop:src={imgThriventLogo} alt="Thrivent" />
    </a>
    <a href="https://linkedin.com/in/sameer-bham-7789261b8" aria-label="LinkedIn">
    ...
    <a href="https://facebook.com/profile.php?id=61555214536310" aria-label="Facebook">
    ...
    <a href="https://instagram.com/financewsameer" aria-label="Instagram">
